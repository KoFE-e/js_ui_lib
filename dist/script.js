...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.changeAttribute = function (attr, value) {
  if (attr && value) {
    for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.deleteAttribute = function (attr) {
  if (attr) {
    for (let i = 0; i < this.length; i++) {
